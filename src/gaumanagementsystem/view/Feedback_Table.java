 ...
 * @author SONIC
 */
public class Feedback_Table extends javax.swing.JFrame {

    /**
     * Creates new form Feedback_Table
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Feedback_Table.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Feedback_Table().setVisible(true);
            }
        });
    }
